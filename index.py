...
# # st.write("hello")
# #  #Widgets
# # # uY = pn.widgets.Select(name = "Variable Selection",
# # #                     options = ['Real GDP', 'Real GDP per Capita', 'Population', 'Personal Income', 'Personal Income per Capita'],
# # #                     value= 'Real GDP', width=175)
# # # st.write(uY)
# # # uY2 = pn.widgets.Select(name = "Variable Selection",
# # #                     options = ['Real GDP', 'Real GDP per Capita', 'Population', 'Personal Income', 'Personal Income per Capita'],
# # #                     value= 'Ppopulation', width=175)

# # # uDate = pn.widgets.DiscreteSlider(name='Date', 
# # #                                 options=np.unique(df1_nat["Date"]).tolist(), 
# # #                                 value='2010-03-31')

# # # uGeoName = pn.widgets.CrossSelector(name='GeoName', value=['United States'], options=np.unique(df1['GeoName']).tolist())    

# # # @pn.depends(uY, uDate)
# # # def react_choropleth(uY, uDate):
# # #     fig = px.choropleth(df1_states[df1_states["Date"] == uDate],
# # #                 locations="Abbrev",
# # #                 color= uY,
# # #                 locationmode="USA-states", 
# # #                 range_color=(0,df1_states[uY].max()), 
# # #                 scope="usa")
# # #     return fig
# # # pn.Row(pn.Column(uY,uDate), react_choropleth)
